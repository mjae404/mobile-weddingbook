...
import video from "../assets/video/wedding_video.mp4";
import poster from "../assets/images/site_image.jpg";

function Couple() {
    return (
        <>
            <div className={styles['couple-video-container']}>
                <video controls width="100%" src={video} poster={poster}>
                </video>
            </div>
